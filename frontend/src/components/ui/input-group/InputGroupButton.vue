...
import { Popover, PopoverContent, PopoverTrigger } from "@/styles/reka-nova/ui/popover";
...
<template>
  <div class="grid w-full max-w-sm gap-6">
    ...
    <InputGroup class="[--radius:9999px]">
      ...
      <InputGroupAddon class="text-muted-foreground !pl-1"> https:// </InputGroupAddon>
      <InputGroupAddon align="inline-end">
        <InputGroupButton size="icon-xs" aria-label="Favorite" @click="isFavorite = !isFavorite">
          <IconStar
